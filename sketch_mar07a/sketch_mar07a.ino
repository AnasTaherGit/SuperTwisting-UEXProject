...
//  else if(receiver_input_channel_1 < 1492)pid_roll_setpoint = (receiver_input_channel_1 - 1492)/3.0;
    ...
    desired_angle_X = 0;
  //We need a little dead band of 16us for better results.
    if(receiver_input_channel_1 > 1540) desired_angle_X = (receiver_input_channel_1 - 1540)/15.0;
    else if(receiver_input_channel_1 < 1460) desired_angle_X = (receiver_input_channel_1 - 1460)/15.0;
 ...
 // else if(receiver_input_channel_2 < 1492)pid_pitch_setpoint = (receiver_input_channel_2 - 1492)/3.0;
  ...
  desired_angle_Y = 0;
  //We need a little dead band of 16us for better results.
  if(receiver_input_channel_2 > 1540) desired_angle_Y = (receiver_input_channel_2 - 1540)/15.0;
  else if(receiver_input_channel_2 < 1460) desired_angle_Y = (receiver_input_channel_2 - 1460)/15.0;
  ...
  if(receiver_input_channel_3 > 1050){ //Do not yaw when turning off the motors.
   if(receiver_input_channel_4 > 1540)pid_yaw_setpoint = (receiver_input_channel_4 - 1540)/3.0;
...
void calculate_pid_angle(){
  ...
  if(pid_i_mem_roll_angle > pid_max_roll_angle)pid_i_mem_roll_angle = pid_max_roll_angle;
  else if(pid_i_mem_roll_angle < pid_max_roll_angle * -1)pid_i_mem_roll_angle = pid_max_roll_angle * -1;
  ...
  if(pid_output_roll_angle > pid_max_roll_angle)pid_output_roll_angle = pid_max_roll_angle;
  else if(pid_output_roll_angle < pid_max_roll_angle * -1)pid_output_roll_angle = pid_max_roll_angle * -1;
  ...
  if(pid_i_mem_pitch_angle > pid_max_pitch_angle)pid_i_mem_pitch_angle = pid_max_pitch_angle;
  else if(pid_i_mem_pitch_angle < pid_max_pitch_angle * -1)pid_i_mem_pitch_angle = pid_max_pitch_angle * -1;
  ...
  if(pid_output_pitch_angle > pid_max_pitch_angle)pid_output_pitch_angle = pid_max_pitch_angle;
  else if(pid_output_pitch_angle < pid_max_pitch_angle * -1)pid_output_pitch_angle = pid_max_pitch_angle * -1;
