...
-- -------------------------------------------------------------
-- 
-- Module: nfp_add2_double
-- Source Path: FPGA_SMC/nfp_add2_double
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_add2_double IS
  ...
  SIGNAL Zero_out1                        : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL EqE1_relop1                      : std_logic;
  SIGNAL Zero0_out1                       : unsigned(51 DOWNTO 0);  -- ufix52
  ...
  SIGNAL Zero_out1_1                      : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL EqE1_relop1_1                    : std_logic;
  SIGNAL Zero0_out1_1                     : unsigned(51 DOWNTO 0);  -- ufix52
  ...
  SIGNAL Switch_out1_2                    : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Switch_out1_3                    : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Switch_out1_4                    : std_logic;  -- ufix1
  ...
  SIGNAL Switch_out1_5                    : std_logic;  -- ufix1
...
BEGIN
  ...
  Zero_out1 <= to_unsigned(16#000#, 11);

  
  EqE1_relop1 <= '1' WHEN Zero_out1 = bExponent ELSE
      '0';

  Zero0_out1 <= to_unsigned(0, 52);

  
  EqM_relop1 <= '1' WHEN Zero0_out1 = bMantissa ELSE
      '0';
  ...
  Zero_out1_1 <= to_unsigned(16#000#, 11);

  
  EqE1_relop1_1 <= '1' WHEN Zero_out1_1 = aExponent ELSE
      '0';

  Zero0_out1_1 <= to_unsigned(0, 52);

  
  EqM_relop1_1 <= '1' WHEN Zero0_out1_1 = aMantissa ELSE
      '0';

  Logical_Operator_out1_2 <= EqE1_relop1_1 AND EqM_relop1_1;

  Inv_out1_1 <=  NOT aSign;
  ...
  Logical_Operator_out1_4 <= Bit_Slice3_out1 OR Bit_Slice2_out1_2;
  ...
  Logical_Operator_out1_5 <= Logical_Operator12_out1_3 OR Logical_Operator12_out1_4;
  ...
  Switch_out1_3 <= Switch10_out1 WHEN Logical_Operator12_out1_5 = '0' ELSE
      Switch13_out1;
  ...
  Switch1_out1_1 <= Switch_out1_3 WHEN Logical_Operator_out1_5 = '0' ELSE
      Switch2_out1_1;
  ...
  Logical_Operator_out1_6 <=  NOT Bit_Slice1_out1_3;
  ...
  Logical_Operator_out1_7 <= Logical_Operator_out1_6 AND Logical_Operator11_out1;

  Bit_Slice1_out1_4 <= if_opp_Sign_1_out1(2);

  Logical_Operator2_out1_3 <= Logical_Operator_out1_7 AND Bit_Slice1_out1_4;
  ...
  Logical_Operator_out1_8 <=  NOT Bit_Slice2_out1_3;

  Logical_Operator1_out1_4 <= Logical_Operator2_out1_4 AND Logical_Operator_out1_8;

  
  Switch_out1_4 <= Logical_Operator_out1_7 WHEN Logical_Operator1_out1_4 = '0' ELSE
      Logical_Operator11_out1;

  Logical_Operator1_out1_5 <= Logical_Operator2_out1_3 OR Switch_out1_4;
  ...
  Switch_out1_5 <= alphaExponent_0_Mantissa_out1 WHEN aExponent_cfType_Exponent_I_out1 = '0' ELSE
      Constant_out1_3;

  alphaaSign_1_bSign_1_out1 <= if_bitconcat_aExponent_aMantiss_2_out1 AND if_bitconcat_aExponent_aMantiss_5_out1;

  
  if_Exponent_0_Mantissa_out1 <= if_bitconcat_aExponent_aMantiss_2_out1 WHEN Switch_out1_5 = '0' ELSE
